...
public class CloudProxyGroup {
    ...
    public void createCloudProxy() {
        ...
        this.cloudProxyCount++;
    }

    public void startCloudProxy(String ip, String serverName, int port, String startShPath) {
        ...
        if(!(this.cloudProxyCount > this.maxCloudProxyCount)) {
            ...
            this.proxy.addListener(new Listener() {
                ...
                public void connected(Connection connection) {
                    AuthPacket proxyAuthPacket = new AuthPacket(ServerType.PROXY.getName(), serverName, ip, port, startShPath);
